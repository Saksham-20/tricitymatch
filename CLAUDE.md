...
- **2026-06-09** Mobile re-theme — aligned colours/darkColours neutral tone to web in-app palette (#FAFAFA/#FFFFFF/#E8E8E8/#2D2D2D); added errorBg/warningBg/successBg/infoBg tokens (light + dark) to shared theme; swept 30+ ad-hoc Tailwind hex codes across admin/bureau/auth/profile screens to theme tokens; created mobile/src/features/calls/callTheme.ts + routed call-screen dark-navy palette through it; 0 TS errors; backend :5001 + web :3001 + Metro :8081 all running.
