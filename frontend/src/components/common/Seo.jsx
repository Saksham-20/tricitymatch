...
// Brand share card (1200x630) — generated by scripts/generate-brand-assets.mjs.
const DEFAULT_IMAGE = `${SITE_URL}/images/og-card.png?v=2`;
  ...
  return (
    <Helmet prioritizeSeoTags>
      ...
      {/* Twitter — card type must be re-emitted here so helmet's dedupe keeps it
          adjacent to the per-route title/image it describes. */}
