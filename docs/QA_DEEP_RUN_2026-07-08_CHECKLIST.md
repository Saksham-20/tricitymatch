...
For **each** public page test at **375 / 768 / 1440**: loads 200, no white screen, no horizontal overflow, no overlap/cutoff, images load, console 0 errors, network no unexpected 4xx/5xx, anti-slop clean (no emoji/unicode-icon/rainbow, "TricityMatch" not "TricityMatch"), Navbar + Footer render, links resolve.
...
- [ ] Brand: "TricityMatch", logo TS, burgundy (not rose/blue except semantic status chips).
